...
public class QuestionThreeAdapter extends RecyclerView.Adapter<QuestionThreeAdapter.ViewHolder> {
    ...
    public QuestionThreeAdapter(Context context, String age) {
    ...
    public void setOnCheckedClickListener(QuestionThreeAdapter.onCheckedClickListener onCheckedClickListener) {
        this.onCheckedClickListener = onCheckedClickListener;
    }

    @NonNull
    @Override
    public QuestionThreeAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.risk_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final QuestionThreeAdapter.ViewHolder holder, final int position) {
        ...
        if (sublistBean.getFACTOR_GROUP_ID() == 3) {
