...
public class TopicChuxueAdapter extends RecyclerView.Adapter<TopicChuxueAdapter.ViewHolder> {

    private Context context;
    private List<RiskAssessmentBean.ServerParamsBean.WENJUANNAMEBean.XUANXIANGBean.WENJUANBean.SublistBean> sublistBeans;

    public TopicChuxueAdapter(Context context) {
    ...
    public TopicChuxueAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.risk_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final TopicChuxueAdapter.ViewHolder holder, final int position) {
    ...
    public void setOnCheckedClickListener(TopicChuxueAdapter.onCheckedClickListener onCheckedClickListener) {
